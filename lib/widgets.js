...
export const WIDGET_CONSTRAINTS = {
  ...
  'trending-tokens': {
    minW: 3,
    maxW: 12,
    minH: 1,   // Need height for list items
    maxH: 1,
    defaultW: 6,
    defaultH: 1,
  },
  'portfolio-tracker': {
    minW: 3,   // Need space for pie chart
    maxW: 8,
    minH: 2,   // Need height for chart and list
    maxH: 4,
    defaultW: 4,
    defaultH: 2,
  },
...
export const widgetRegistry = {
  ...
  portfolioTracker: {
    ...
    description: 'Visualize your wallet holdings with a pie chart',
    icon: '📊',
    category: 'portfolio',
    component: lazy(() => import('@/components/widgets/PortfolioTracker')),
    defaultSize: 'large',
    defaultConfig: {
      showLegend: true,
      showValues: true,
      minDisplayValue: 1, // Minimum USD value to display
    },
    configSchema: {
      showLegend: {
        type: 'boolean',
