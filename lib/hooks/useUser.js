...
export function useUser() {
  ...
  useEffect(() => {
    ...
    const fetchUser = async () => {
      console.log('🔍 useUser: checking connection', { isConnected, address });
      ...
      console.log('🔍 useUser: fetching user for address', address);
      setIsLoading(true);
      setError(null);

      try {
        const userData = await getOrCreateUser(address);
        console.log('✅ useUser: user fetched', userData);
